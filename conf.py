...
BLOG_AUTHOR = "ink9"  # (translatable)
BLOG_TITLE = "INK 9"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://ink9.ru/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://ink9.ru/"
BLOG_EMAIL = "a.tsidaev@gmail.com"
BLOG_DESCRIPTION = "Спектрум и всякое"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ('/index.html', 'Блог', 'bi-house'),
        ('/archive.html', ' По годам', 'bi-calendar2-date'),
        ('/categories/index.html', ' По темам', 'bi-tags'),

        #('#', 'Компьютеры', 'bi-keyboard'),
        #('#', 'Архивы', 'bi-floppy'),
        ('/library/', 'Библиотека', 'bi-book'),

        ('/about/', 'О сайте', 'bi-file-person'),
    )
}
